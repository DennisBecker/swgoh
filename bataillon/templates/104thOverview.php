<tr>
	...
	<td <?php echo matchesRequirement('Veteran Smuggler Han Solo', $characters, 7, 7) ? 'class="ready"' : 'class="notReady"'; ?>><?php echo hasChar('Veteran Smuggler Han Solo', $characters); ?></td>
	<td <?php echo matchesRequirement('Veteran Smuggler Chewbacca', $characters, 7, 7) ? 'class="ready"' : 'class="notReady"'; ?>><?php echo hasChar('Veteran Smuggler Chewbacca', $characters); ?></td>
	...
	<td <?php echo matchesRequirement('Death Trooper', $characters, 7, 11) ? 'class="ready"' : 'class="notReady"'; ?>><?php echo hasChar('Death Trooper', $characters); ?></td>
	<td <?php echo matchesRequirement('Snowtrooper', $characters, 7, 11) ? 'class="ready"' : 'class="notReady"'; ?>><?php echo hasChar('Snowtrooper', $characters); ?></td>
	<td <?php echo matchesRequirement('Grand Admiral Thrawn', $characters, 7, 11) ? 'class="ready"' : 'class="notReady"'; ?>><?php echo hasChar('Grand Admiral Thrawn', $characters); ?></td>
	<td <?php echo matchesRequirement('Chirrut Îmwe', $characters, 6, 11) ? 'class="ready"' : 'class="notReady"'; ?>><?php echo hasChar('Chirrut Îmwe', $characters); ?></td>
	<td <?php echo matchesRequirement('Baze Malbus', $characters, 6, 11) ? 'class="ready"' : 'class="notReady"'; ?>><?php echo hasChar('Baze Malbus', $characters); ?></td>
	<td <?php echo matchesRequirement('Asajj Ventress', $characters, 7, 11) ? 'class="ready"' : 'class="notReady"'; ?>><?php echo hasChar('Asajj Ventress', $characters); ?></td>
	<td <?php echo matchesRequirement('Mother Talzin', $characters, 7, 11) ? 'class="ready"' : 'class="notReady"'; ?>><?php echo hasChar('Mother Talzin', $characters); ?></td>
	<td <?php echo matchesRequirement('Old Daka', $characters, 7, 11) ? 'class="ready"' : 'class="notReady"'; ?>><?php echo hasChar('Old Daka', $characters); ?></td>
